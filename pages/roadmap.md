...
* Try to determine if you got all the data you wanted. For example, are there summary numbers published somewhere that you could try to replicate? Do you see data from all the years that you expected? (and don't just look at the start and end, truly check that you're not missing a year worth of data in the middle -- I'm speaking from experience here)
